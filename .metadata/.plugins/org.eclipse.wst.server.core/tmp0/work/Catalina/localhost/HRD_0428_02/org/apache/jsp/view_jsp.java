 ...
 * Generated at: 2020-04-30 04:51:42 UTC
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	VO vo = dao.totlist();
      ...
      out.write("\t<section>\r\n");
      out.write("\t\t<h2 class=\"title\">과정평가형 자격(학생성적조회)</h2>\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( str.substring(0,1)+"-"+str.substring(1,2)+"-"+str.substring(2,4));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
 ...
 if(list.get(x).getGender().equalsIgnoreCase("M")){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( list.get(x).getKor() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( list.get(x).getEng() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( list.get(x).getMat() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( list.get(x).getTot() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( Math.round(dou*10)/10.0 );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>전체총점</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( vo.getKortot());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( vo.getEngtot());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( vo.getMattot());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>전체평균</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( vo.getKoravg());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( vo.getEngavg());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( vo.getMatavg());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
