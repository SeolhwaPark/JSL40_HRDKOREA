 ...
 * Generated at: 2020-04-30 04:50:55 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	List<VO> list = dao.list();
      ...
      out.write("\t<section>\r\n");
      out.write("\t\t<h2 class=\"title\">학생정보 조회</h2>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td style=\"background-color:#e198b4\"><a href=\"modify.jsp?hakbun=");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( list.get(x).getPhone1()+"-"+list.get(x).getPhone2()+"-"+list.get(x).getPhone3() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t");
 if(list.get(x).getGender().equalsIgnoreCase("M")){ 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( date.substring(0,4)+"년"+date.substring(5,7)+"월"+date.substring(8,10)+"일" );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
