	...
	<div class="content">
		<form name="insert" method="post" action="insert_pro.jsp">
			<table>
				...
				<tr>
					<th>생년월일</th>
					<td><input type="text" name="artist_birth1" value="">년</td>
					<td><input type="text" name="artist_birth2" value="">월</td>
					<td><input type="text" name="artist_birth3" value="">일</td>
				</tr>
				<tr>
					<th>성별</th>
					<td><input type="radio" name="artist_gender" value="M">남
						<input type="radio" name="artist_gender" value="F">여
					</td>
				</tr>
				<tr>
					<th>특기</th>
				...
				<tr>
					...
					<input type="button" name="" value="오디션등록" onClick="send()">
					<input type="button" name="" value="다시쓰기" onClick="del()">
					</td>
				</tr>
			</table>
		</form>
