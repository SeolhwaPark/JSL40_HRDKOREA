...
<%
	...
	List<VO> list = dao.dnameList(dname);
	...
	<div class="content">
			<table>
				...
				if(list != null){
					...
					str = list.get(x).getIndate();
					strr = list.get(x).getOutdate();
				%>
				<tr>
					...
					<td><%= str.substring(0,4)+"년"+str.substring(5,7)+"월"+str.substring(8,10)+"일"%>
					</td>
					<td><%= strr!=null?strr.substring(0,4)+"년"+strr.substring(5,7)+"월"+strr.substring(8,10)+"일":""%>
					</td>
