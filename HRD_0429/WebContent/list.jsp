...
function send() {
	...
	else if(insert.radio[1].checked == true && insert.dname.selectedIndex==0){
		alert("부서명이 선택되지 않았습니다.");		
		return false;
	}
	else if(insert.radio[1].checked == true && insert.dname.selectedIndex!=0){
	...
	}else if(insert.radio[0].checked == true && insert.sawon.value !=""){
...
<section>
	...
	<div class="content">
		<form name="insert" method="post">
			<table>
				<tr>
					<th><input type="radio" name="radio" value="1" checked>사원번호로 조회</th>
					<td><input type="text" name="sawon">
					</td>
				</tr>
				<tr>
					<th><input type="radio" name="radio" value="2">부서명으로 조회</th>
					<td>
					<select name="dname">
						<option value=""></option>
						...
						<option value="영업관리부">영업관리부</option>
					</select>
					</td>
				</tr>
				<tr>
